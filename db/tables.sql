...
CREATE TABLE QUESTION (
    ...
    QUESTION_CONTENT_ID uuid, -- TODO NOT NULL
    FOREIGN KEY (QUESTION_CONTENT_ID) REFERENCES CONTENT(ID),
    AUTHOR uuid NOT NULL,
    FOREIGN KEY (AUTHOR) REFERENCES MEDUSER(ID),
...
/* ANSWERS */
CREATE TABLE ANSWER (
    ID uuid DEFAULT gen_random_uuid() PRIMARY KEY, -- TODO NOT needed
